defmodule D2CrucibleRouletteWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use D2CrucibleRouletteWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = D2CrucibleRoulette.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = D2CrucibleRoulette.Accounts.generate_user_session_token(user)
